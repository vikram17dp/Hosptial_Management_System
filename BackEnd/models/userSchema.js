...
userSchema.methods.comparePassword =async function(enterdpassword){ //comparePassword Method
    return await bcrypt.compare(enterdpassword,this.password) // boolean
}
userSchema.methods.generateJsonWebToken = function(){ //generatePassword Method
